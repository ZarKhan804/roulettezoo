...
const gameImage =
  "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRKTS2AsrvQu0sraj-Psw4Gdgpejbe3FTrcNTbLofvDjQ&s=10";
        ...
        >
          ...
          <div className="min-w-0">
            <h1 className="whitespace-nowrap text-[20px] font-black leading-tight tracking-tight text-white sm:text-[24px]">
              ROULETTE<span className="text-yellow-400"> ZOO GAME</span>
            </h1>
